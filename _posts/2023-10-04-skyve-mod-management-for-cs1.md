...
อย่าลืมกดสมัครสมาชิก 2 ตัวด้านข้างนี้ไปด้วย

เมื่อกดสมัครสมาชิกแล้วให้เข้าเกมไปเปิดใช้งานม็อดภายในตัวเกม (เปิดทั้ง 3 ตัว)

หากเป็นการติดตั้งครั้งแรกตัว Patcher จะแจ้งเตือนให้คุณปิดเกมก่อนหนึ่งครั้ง แล้วค่อยเข้ามาใหม่ 

ในบางกรณีเมื่อทำการติดตั้งเสร็จแล้วจะพบว่ามีไอคอนของ Skyve ปรากฏบนหน้าจอเดกส์ทอปดังภาพ

เมื่อเข้าเกมจะปรากฏเมนูใหม่ขึ้นมา หากขึ้นแบบนี้แสดงว่าการติดตั้งเรียบร้อยแล้ว 

ในบางเครื่องเมื่อกดเข้าไปที่เมนูของ Skyve แล้วปรากฏว่าตัวแอปไม่แสดงรายงานความเข้ากันได้ ดังภาพ ให้ลองทำตาม [การตั้งค่าเพิ่มเติมต่าง ๆ](#5-การตั้งค่าเพิ่มเติมต่าง ๆ)
